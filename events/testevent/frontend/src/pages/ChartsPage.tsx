...
function ChartCard({ chart, metadata }: { chart: EventChartData; metadata: Record<string, any> }) {
  ...
  return (
    <Link to={`/chart/${chart.hash}`} className="group relative overflow-hidden rounded-xl bg-base-200 shadow-sm ring-1 ring-base-content/5 transition-all hover:shadow-md hover:ring-base-content/10 block">
      {/* Banner */}
